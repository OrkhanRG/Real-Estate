			...
			<div class="col-md-9">
				...
				<div class="row">
					<ul id="listingLoadMoreWrapper" class="properties-listing sort-destination p-none" data-total-pages="2">
						...
						if (empty($_POST['axtarilan'])) {

							$emlaksor=$db->prepare("select * from emlak where emlak_status=:status and emlak_qiymet>=:emlak_qiymetaz and emlak_qiymet<=:emlak_qiymetcox");
							...
							$emlaksor=$db->prepare("SELECT * from emlak where emlak_baslig LIKE ? ");
							$emlaksor->execute(array("%$axtarilan%"));
