                ...
                <div class="x_content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="mezmun_ad" placeholder="Məzmun adını daxil edin..." class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <textarea  name="mezmun_detay" class="ckeditor"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="mezmun_keyword" placeholder="Məzmun açar sözlərini daxil edin..." class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div align="right" class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                      <button type="submit" name="mezmunsaxla" class="btn btn-success">Saxla</button>
                    </div>
                  </div>
